...
dim shared g as integer=0
dim shared h as string
...
if instr(b,"goto ") =1 then gotos
if instr(b,"pause ") =1 then gotos
if instr(b,"pause") =1 and f=5 then pauses

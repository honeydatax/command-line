...
print "do you want to change this client id Y or N"
input iiinp
print iiinp

if iiinp="n" or iiinp ="N" then goto escape

imps=".header on"+chr(13)+chr(10)+".mode tabs"+chr(13)+chr(10)+".width 3, 3 , 3 , 3"+chr(13)+chr(10)+"UPDATE list SET name ="
print "client name"
input iiinp
imps=imps+chr(34)+iiinp+chr(34)+",phone="
print "client phone"
input iiinp
imps=imps+chr(34)+iiinp+chr(34)+",address="
print "client address"
input iiinp
imps=imps+chr(34)+iiinp+chr(34)+" where id="+iinp
